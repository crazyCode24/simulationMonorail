...
class MonoCairoMap2 extends StatefulWidget {
  const MonoCairoMap2({super.key});

  @override
  _MonorailMapState createState() => _MonorailMapState();
}

class _MonorailMapState extends State<MonoCairoMap2>
  ...
  void initState() {
    ...
    _locations = [
      ...
      LatLng(30.025679, 31.490731), // الجامعة الامريكية
      LatLng(30.013807, 31.519947), // الاندلس
      LatLng(30.026915, 31.533201), // النافورة_
    ];
    _stations = [
      LatLng(30.026848, 31.560483), // الربوة
      LatLng(30.026915, 31.533201), // النافورة
  ...
  void _moveMarker(double speed) async {
    ...
    //     seconds: 3)); // Wait for 3 seconds before starting the animation
