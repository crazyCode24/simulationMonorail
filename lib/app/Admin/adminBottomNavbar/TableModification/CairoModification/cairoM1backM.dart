...
class cairoM1back extends StatefulWidget {
  const cairoM1back({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<cairoM1back> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('cairoM1back').snapshots();
  }
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            title: Text('Back > monorail 1 (Modify)'),
          ),
        ),
      ),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                await FirebaseFirestore.instance.collection('cairoM1back').add({
                  'monoNo': monoNo,
