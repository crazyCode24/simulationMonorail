...
class cairoM1go extends StatefulWidget {
  const cairoM1go({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<cairoM1go> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('cairoM1go').snapshots();
  }
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                await FirebaseFirestore.instance.collection('cairoM1go').add({
                  'monoNo': monoNo,
