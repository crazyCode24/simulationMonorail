...
class cairoM2back extends StatefulWidget {
  const cairoM2back({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<cairoM2back> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('cairoM2back').snapshots();
  }
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            title: Text('Back > monorail 2 (Modify)'),
          ),
        ),
      ),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                await FirebaseFirestore.instance.collection('cairoM2back').add({
                  'monoNo': monoNo,
