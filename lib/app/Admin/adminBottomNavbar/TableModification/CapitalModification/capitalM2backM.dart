...
class capitalM2back extends StatefulWidget {
  const capitalM2back({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<capitalM2back> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('capitalM2back').snapshots();
  }
