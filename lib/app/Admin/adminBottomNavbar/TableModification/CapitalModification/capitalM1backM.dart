...
class capitalM1back extends StatefulWidget {
  const capitalM1back({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<capitalM1back> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('capitalM1back').snapshots();
  }
