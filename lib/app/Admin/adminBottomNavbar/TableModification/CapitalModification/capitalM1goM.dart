...
class capitalM1go extends StatefulWidget {
  const capitalM1go({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<capitalM1go> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('capitalM1go').snapshots();
  }
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            title: Text('go > monorail 1 (Modify)'),
          ),
        ),
      ),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                await FirebaseFirestore.instance.collection('capitalM1go').add({
                  'monoNo': monoNo,
