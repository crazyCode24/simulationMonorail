...
class capitalM2go extends StatefulWidget {
  const capitalM2go({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<capitalM2go> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('capitalM2go').snapshots();
  }
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                await FirebaseFirestore.instance.collection('capitalM2go').add({
                  'monoNo': monoNo,
