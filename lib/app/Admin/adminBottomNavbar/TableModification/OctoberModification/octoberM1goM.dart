...
class octoberM1goM extends StatefulWidget {
  const octoberM1goM({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<octoberM1goM> {
  late Stream<QuerySnapshot> _trainsStream;

  @override
  void initState() {
    super.initState();
    _trainsStream = FirebaseFirestore.instance.collection('Trains').snapshots();
  }
