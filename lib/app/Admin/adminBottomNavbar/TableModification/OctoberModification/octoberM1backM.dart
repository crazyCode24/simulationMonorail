...
class octoberM1backM extends StatefulWidget {
  const octoberM1backM({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<octoberM1backM> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('octoberM1back').snapshots();
  }
