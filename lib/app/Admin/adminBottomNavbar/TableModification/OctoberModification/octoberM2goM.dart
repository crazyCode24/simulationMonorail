...
class octoberM2goM extends StatefulWidget {
  const octoberM2goM({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<octoberM2goM> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('octoberM2goM').snapshots();
  }
