...
class octoberM2backM extends StatefulWidget {
  const octoberM2backM({Key? key}) : super(key: key);

  @override
  _AdminPageState createState() => _AdminPageState();
}

class _AdminPageState extends State<octoberM2backM> {
  ...
  void initState() {
    super.initState();
    _trainsStream =
        FirebaseFirestore.instance.collection('octoberM2backM').snapshots();
  }
