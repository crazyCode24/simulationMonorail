...
class Trip1_go_capitalM1 extends StatefulWidget {
  const Trip1_go_capitalM1({Key? key}) : super(key: key);

  @override
  _MonorailScheduleState createState() => _MonorailScheduleState();
}

class _MonorailScheduleState extends State<Trip1_go_capitalM1> {
  ...
  void initState() {
    super.initState();
    _trainsCollection = _firestore.collection('capitalM1go');
  }
