...
class Trip6_Back extends StatefulWidget {
  const Trip6_Back({Key? key}) : super(key: key);

  @override
  _MonorailScheduleState createState() => _MonorailScheduleState();
}

class _MonorailScheduleState extends State<Trip6_Back> {
  ...
  void initState() {
    super.initState();
    _trainsCollection = _firestore.collection('octoberM2backM');
  }
