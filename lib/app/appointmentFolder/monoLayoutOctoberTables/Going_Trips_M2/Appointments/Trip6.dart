...
class Trip6_GoM2 extends StatefulWidget {
  const Trip6_GoM2({Key? key}) : super(key: key);

  @override
  _MonorailScheduleState createState() => _MonorailScheduleState();
}

class _MonorailScheduleState extends State<Trip6_GoM2> {
  ...
  void initState() {
    super.initState();
    _trainsCollection = _firestore.collection('octoberM2goM');
  }
