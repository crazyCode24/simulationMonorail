...
class Trip1_Back_CairoM2 extends StatefulWidget {
  const Trip1_Back_CairoM2({Key? key}) : super(key: key);

  @override
  _MonorailScheduleState createState() => _MonorailScheduleState();
}

class _MonorailScheduleState extends State<Trip1_Back_CairoM2> {
  ...
  void initState() {
    super.initState();
    _trainsCollection = _firestore.collection('cairoM2back');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'back Schedule of the monorail 2',
